        ...
        <header> 
                <router-link to='/'>
                    <div class="header--logo">
                        <img src="../assets/movlogo.png" alt="">
                    </div>
                </router-link>
                <div class="header--menu">
                    <router-link to='/hated' active-class="active" exact>
                        <div class="header--menu__hated" >
                            <svg id="light" 
                    ...
                    <router-link to='/watchlist' active-class="active" exact>
                    ...
                    <router-link to='/favorite' active-class="active" exact>
                        <div class="header--menu__favorite" >
                            <svg 
                            viewBox="0 0 23 20" 
                            fill="none" 
                            xmlns="http://www.w3.org/2000/svg">
